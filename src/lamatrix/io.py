    ...
    def _get_table_matter(self):
            ...
            for idx in range(self.width):
                ...
                formatted_prior_mean, formatted_prior_error = (
                    format_significant_figures(self.priors[idx].mean, self.priors[idx].std)
                )
...
class IOMixins():
    ...
    def _create_save_data(self):
        ...
        kwargs = {attr: process(getattr(self, attr)) for attr in self._initialization_attributes}
        ...
        data_to_store = {
            ...
            "posteriors": self.posteriors.to_dict() if self.posteriors is not None else None,
